...
status: active
discoveredAt: '2026-04-02T05:57:38.339Z'
...
- directory-sync_status: Get sync and git repository status — last sync time, watching state, pending git changes.
...
- system_insights: Get content insights and analytics. Available types: overview, publishing-cadence, content-health, topic-distribution, traffic-overview.
